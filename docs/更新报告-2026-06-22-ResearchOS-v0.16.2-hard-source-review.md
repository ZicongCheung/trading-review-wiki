...
```sh
npm --silent run codex:ingest -- research-os agent review --project /path/to/your-trading-wiki
```
...
- `npm --silent run codex:ingest -- stock-feedback verify --project /path/to/your-trading-wiki`：`status=ok`
- `npm --silent run codex:ingest -- hypothesis verify --project /path/to/your-trading-wiki`：`status=ok`
- `npm --silent run codex:ingest -- research-os agent verify --project /path/to/your-trading-wiki`：`status=ok`
