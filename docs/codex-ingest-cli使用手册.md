...
npm run codex:ingest -- finalize \
  --report /path/to/your-trading-wiki/.llm-wiki/codex-ingest/<run-id>
```
...
```sh
sed -n '1,160p' /path/to/your-trading-wiki/.llm-wiki/agent-runs/<run-id>-ask/final.md
```
...
```sh
sed -n '1,160p' /path/to/your-trading-wiki/.llm-wiki/policy-proposals/<timestamp>-autoresearch-policy-proposals.md
```
...
```sh
open /path/to/your-trading-wiki/.llm-wiki/codex-ingest/<run-id>/wiki-change-review.md
```
...
```sh
npm run codex:ingest -- apply \
  --manifest /path/to/your-trading-wiki/.llm-wiki/codex-ingest/<run-id>/changes.json \
  --write
```
