...
- 技能入口：`~/.codex/skills/trading-wiki-ask/scripts/tw-ask.sh`
- CLI 分发：`/path/to/trading-review-wiki/scripts/codex-ingest.mjs`
- 核心实现：`/path/to/trading-review-wiki/scripts/codex-ingest-lib.mjs`
- 实时知识库：`/path/to/your-trading-wiki`
...
```sh
~/.codex/skills/trading-wiki-ask/scripts/tw-ask.sh \
  --query "你的问题" \
  --show-sources
```
