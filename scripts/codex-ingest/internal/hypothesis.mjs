...
// Machine-local defaults intentionally empty: use
// TRADING_WIKI_DEFAULT_FINANCE_ENTITY_AUDIT_ROOTS / --finance-entity-audit-roots,
// or project-local .llm-wiki/sag-entity-audit via financeEntityAuditSearchRoots.
